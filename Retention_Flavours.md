...
```wavedrom
 ...
 foot:{
   tick:0,
   text:'1 pin, restore on power-up, obey reset',
 },
 config: { skin: "narrow"}
}
...
{signal: [
  {name: 'CLK',    wave: 'P...x...0P...', period: 2},
  {name: 'D',      wave: 'x3.4.5.x.........3.4.5.6.7', data: 'D1 D2 D3 D4 D5 D6 D7 D8 D9 D10 D11 D12'},
  {name: 'Q',      wave: 'x.3.4.5x.z.....x.03.4.5.6.', data: 'D1 D2 D3 D4 D5 D6 D7'},
  {name: 'RESET',  wave: '0...........1.......0.....'},
  {name: 'RETN',   wave: '1......0.........1........', node: '.......a.........d........'},
  {name: 'PWR',    wave: '1........0.....1..........', node: '.........b.....c..........'}, 
  ],
...
### 1-pin, restore on power-up, ignore reset, clock must be low
 ```wavedrom
 {signal: [
  {name: 'CLK',    wave: 'P...0x.0.P...', period: 2},
  {name: 'D',      wave: 'x3.4.5.x.........3.4.5.6.7', data: 'D1 D2 D3 D4 D5 D6 D7 D8 D9 D10 D11 D12'},
  {name: 'Q',      wave: 'x.3.4.5..z.....5.03.4.5.6.', data: 'D1 D2 D3 D3 D4 D5 D6 D7'},
 ...
 foot:{
   tick:0,
   text:'1-pin, restore on power-up, ignore reset, clock must be low',
 },
 config: { skin: "narrow"}
}
```
...
{signal: [
  {name: 'CLK',    wave: 'P...0x.0.P...', period: 2},
  {name: 'D',      wave: 'x3.4.5.x.........3.4.5.6.7', data: 'D1 D2 D3 D4 D5 D6 D7 D8 D9 D10 D11 D12'},
  {name: 'Q',      wave: 'x.3.4.5..z.....05.3.4.5.6.', data: 'D1 D2 D3 D3 D4 D5 D6 D7'},
  {name: 'RESET',  wave: '0.............1.0.........'},
  {name: 'RETN',   wave: '1......0.........1........', node: '.......a.........d........'},
  {name: 'PWR',    wave: '1........0.....1..........', node: '.........b.....c..........'}, 
  ],
 ...
 foot:{
   tick:0,
   text:'1-pin, restore on power-up, obey reset, reset not sticky, clock must be low during restore',
 },
 config: { skin: "narrow"}
}
```
